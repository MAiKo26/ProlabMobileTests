...
public class VerifyLoginSettingsIncorrect {
    ...
    @Test
    public void verifyLoginSettingsWrong() throws InterruptedException {
                        ...
                        childAtPosition(
                                allOf(withClassName(is("android.widget.LinearLayout")),
                                        childAtPosition(
                                                ...
                                                0)),
                                1)));
        editText.perform(scrollTo(), replaceText("0000"), closeSoftKeyboard());
                        ...
                        childAtPosition(
                                allOf(withClassName(is("android.widget.LinearLayout")),
                                        childAtPosition(
                                                ...
                                                0)),
                                1)));
        editText2.perform(scrollTo(), replaceText("0000"));

        ViewInteraction editText3 = onView(
                allOf(withId(android.R.id.edit), withText("0000"),
                        childAtPosition(
                                allOf(withClassName(is("android.widget.LinearLayout")),
                                        childAtPosition(
                                                withClassName(is("android.widget.ScrollView")),
                        ...
                        childAtPosition(
                                allOf(withClassName(is("android.widget.LinearLayout")),
                                        childAtPosition(
                                                ...
                                                0)),
                                1)));
        editText4.perform(scrollTo(), replaceText("wrongver"));

        ViewInteraction editText5 = onView(
                allOf(withId(android.R.id.edit), withText("wrongver"),
                        childAtPosition(
                                allOf(withClassName(is("android.widget.LinearLayout")),
                                        childAtPosition(
                                                withClassName(is("android.widget.ScrollView")),
                        ...
                        childAtPosition(
                                allOf(withClassName(is("android.widget.LinearLayout")),
                                        childAtPosition(
                                                ...
                                                0)),
                                1)));
        editText6.perform(scrollTo(), replaceText("wronguser"));

        ViewInteraction editText7 = onView(
                allOf(withId(android.R.id.edit), withText("wronguser"),
                        childAtPosition(
                                allOf(withClassName(is("android.widget.LinearLayout")),
                                        childAtPosition(
                                                withClassName(is("android.widget.ScrollView")),
                        ...
                        childAtPosition(
                                allOf(withClassName(is("android.widget.LinearLayout")),
                                        childAtPosition(
                                                ...
                                                0)),
                                1)));
        editText8.perform(scrollTo(), replaceText("0000"));
                        ...
                        childAtPosition(
                                allOf(withClassName(is("android.widget.LinearLayout")),
                                        childAtPosition(
                                                ...
                                                0)),
                                1)));
        editText10.perform(scrollTo(), replaceText("wronguser"), closeSoftKeyboard());
                        ...
                        childAtPosition(
                                allOf(withClassName(is("android.widget.LinearLayout")),
                                        childAtPosition(
                                                ...
                                                0)),
                                1)));
        editText11.perform(scrollTo(), replaceText("0000"), closeSoftKeyboard());
