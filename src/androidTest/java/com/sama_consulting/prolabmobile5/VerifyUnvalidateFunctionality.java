...
public class VerifyUnvalidateFunctionality {
        ...
        @Test
        public void verifyValidateFunctionality() throws InterruptedException {
                            ...
                            childAtPosition(
                                    allOf(withClassName(is("android.widget.LinearLayout")),
                                            childAtPosition(
                                                    ...
                                                    0)),
                                    1)));
            editText2.perform(scrollTo(), replaceText("SysAdmin"), closeSoftKeyboard());
            ...
            // Vu que on peut pas faire des Conditions dans un Test Espresso l'ordre des Tests est important pour qu'il soit valide
            ...
            ViewInteraction imageView2 = onView(
                    allOf(withId(R.id.valide), withContentDescription("Validé"),
                            childAtPosition(
                                    childAtPosition(
